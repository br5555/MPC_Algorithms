#ifndef FASTER_MPC_SOLVER
#define FASTER_MPC_SOLVER
...
public:
	...
	Faster_mpc_solver(Matrix<double, num_state_variables, num_state_variables> A, Matrix<double, num_state_variables, num_manipulated_variables>  B,
...
private:
	...
	double residuum, residuum_signal, residuum_state, mi_0, mi_inc, mi_dec, mi_max, min_residuum, alfa, residuum_old;
	...
	Matrix<double, num_cost_functions, mpc_control_horizon*num_heuristic_variables> Jacobian;
